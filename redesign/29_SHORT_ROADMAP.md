...
Sem human rubric labeling for **Wave-100** (compute `critical_error_rate` from `label_*` columns). Open **Wave-500/1000** only if gate passes; keep hierarchy in safe default. **Dir+** after V3 gate.
